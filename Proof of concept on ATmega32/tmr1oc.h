...
void tmr1_act(void (*isr_ptr)(void));				//install user handler

void tmr1oca_setpr(unsigned short pr);					//set oc1 period
void tmr1oca_act(void (*isr_ptr)(void));				//install user handler
void tmr1ocb_setpr(unsigned short pr);					//set oc1 period
void tmr1ocb_act(void (*isr_ptr)(void));				//install user handler
